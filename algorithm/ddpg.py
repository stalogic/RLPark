...
import torch
import numpy as np
from .util import OffPolicyRLModel, DeterministicPolicyNetwork, ContinuousQValueNetwork
...
class DDPG(OffPolicyRLModel):
    ...
    def __init__(self, state_dim_or_shape, action_dim_or_shape, hidden_dim=32, batch_size=128, action_bound=1, lr=1e-3, gamma=0.99, capacity=10000, device="cpu", **kwargs) -> None:
        ...
        self.qvalue_lr_scheduler = torch.optim.lr_scheduler.StepLR(self.qvalue_optimizer, step_size=100, gamma=0.955)
